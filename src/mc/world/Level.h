...
#include "mc/common/AutomaticID.h"
#include "mc/common/Factory.h"
#include "mc/common/IDType.h"
#include "mc/common/NonOwnerPointer.h"
#include "mc/common/OwnerPtrFactory.h"
